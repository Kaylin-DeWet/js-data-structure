// Write a function `inRange(min, max, n)` that
// accepts three numbers as arguments. The
// function should return a boolean indicating
// if `n` is between `min` and `max` inclusive.
