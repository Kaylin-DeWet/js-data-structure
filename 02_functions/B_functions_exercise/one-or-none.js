// Write a function `oneOrNone` that accepts two
// booleans as arguments. The function should
// return true if exactly one of the arguments
// is true. If BOTH arguments are true, then it
// should return false.
